    ...
    render() {
        return (
            <section className="contact-me-section">
                <form  className ="contact-form" action="https://mailthis.to/contactkevin"
    method="POST" encType="multipart/form-data">
                    <div className="contact-name">
                        <input className="contact-input" name="name" placeholder="Enter Name" required/>
                    </div>
                    <div className="contact-name">
                        <input type = "email" className="contact-input" name="_replyto" placeholder="Enter Email" required/>
                    </div>
                    <div className="contact-name">
